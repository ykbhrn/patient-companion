    ...
    sections: [
      {
        ...
        body: "Crescent Lodge has been part of the Clapham Common community for over 50 years and is one of the larger dental practices in London. Our friendly team looks after everyone from adults and children to nervous patients, and we work hard to make you feel comfortable from the moment you arrive. We are a fully private practice and do not provide NHS treatment.",
      },
      {
